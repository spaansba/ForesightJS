...
export class ForesightDebugger {
  ...
  private static devtools: ForesightDebugger
  ...
  public static get instance(): ForesightDebugger {
    return ForesightDebugger.devtools
  }
  ...
  public static initialize(
    ...
    if (!ForesightDebugger.devtools) {
      ForesightDebugger.devtools = new ForesightDebugger(foresightManager)
    }
    const devtools = ForesightDebugger.devtools
