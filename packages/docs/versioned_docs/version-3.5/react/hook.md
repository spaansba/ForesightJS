...
- [`registerResults`](../configuration/element-settings.md#return-properties) - Registration details like `isRegistered`
...
- [React Router](./react-router.md#foresightlink-component)
- [Next.js](./nextjs.md#foresightlink-component)
