...
This is the main type used in ForesightJS as it gathers all information about a registered element. `ForesightElementData` is returned in most [events](../events.md) as `elementData`
...
Snapshot of the current ForesightManager state, including all [global settings](../configuration/global-settings.md), registered elements, position observer data, and interaction statistics. This is primarily used for debugging, monitoring, and development purposes.
...
This type is used in the [`useForesight`](../react/hook.md) hook for React.
