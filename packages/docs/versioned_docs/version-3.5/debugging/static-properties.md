...
- `eventListeners` - `Map` of all event listeners listening to [ForesightManager Events](../events.md).
- `globalSettings` - Current [global configuration](../configuration/global-settings.md) settings
