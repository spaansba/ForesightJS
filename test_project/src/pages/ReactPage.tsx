...
const ReactPage: React.FC = () => {
  ...
  useEffect(() => {
    console.log("ReactPage: Initializing ForesightManager");
  ...
  return (
    <div className="p-5 font-sans">
      ...
      <p className="mb-4">Hover over the colored boxes to test the ForesightManager functionality.</p>
      ...
      <div>
        ...
        {/* Notification area */}
        <div className="mt-5 p-3 bg-gray-100 rounded h-8 font-mono">
          {notification}
        </div>
      </div>
      ...
      <div className="mt-8 pt-5 border-t border-gray-200">
        ...
        <p className="mb-3">Generate multiple elements with 5px hitSlop to test ForesightManager performance</p>
      ...
      <div className="mt-8 pt-5 border-t border-gray-200">
        ...
        <ul className="list-disc pl-5">
          <li className="mb-2">The ForesightManager tracks mouse movement and predicts its trajectory</li>
          <li className="mb-2">When your mouse is predicted to enter an element's hitSlop area, the callback triggers</li>
          <li className="mb-2">Enable Debug Mode to visualize the hitSlop areas and trajectory prediction</li>
          <li className="mb-2">Adjust the settings to see how they affect the prediction behavior</li>
        </ul>
      </div>
    </div>
  );
